...
export const GET: APIRoute = ({ site }) => {
  ...
  const apps = getApps();
  const urls = ['', '/start', '/opportunities', '/directory', '/company-directory', '/deals', '/news', '/jobs', '/resources', '/partner', '/tools', '/open-source', '/showcase', '/sell', '/sprint-setup', ...apps.map((app) => `/${app.slug}`)];
